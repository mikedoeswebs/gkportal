	...
	<div class="container mx-auto my-8">
		<header class="entry-header mb-8 border-b pb-8">
			<h1 class="entry-title text-2xl lg:text-5xl font-extrabold mb-0 flex items-center justify-center">
				...
				<span class="ml-4"><?php echo isset($_GET['_profile_type']) && $_GET['_profile_type'] == 'staff' ? 'Staff Search' : 'Player Search'; ?></span>
			</h1>
		</header>
		<div class="entry-content flex flex-col lg:flex-row lg:items-start relative">
			<?php if (have_posts()) : ?>
				<div class="lg:w-1/4 sticky top-0 lg:top-4 z-10 bg-gray-100 lg:bg-transparent -mx-4 lg:mx-0 mb-4 lg:mb-0">
					...
					<div id="player-filters" class="hidden lg:block px-4 lg:pl-0 lg:pr-10 overflow-auto h-[calc(100vh-3rem)]">
						<p class="text-xl font-bold hidden lg:block">Filter Players</p>
						<div class="mb-6">
							<?php echo facetwp_display('selections'); ?>
							<a href="javascript:;" class="text-sm inline-flex items-center bg-blue-500 hover:bg-blue-700 text-white no-underline py-3 px-4 rounded transition-all cursor-pointer" onclick="FWP.reset()">Clear All Filters</a>
						</div>
						<div class="mb-6">
						...
						<div class="mb-6">
							<strong class="mb-1 block">Profile Type</strong>
							<div class="text-sm">
								<?php echo facetwp_display('facet', 'profile_type'); ?>
							</div>
						</div>
						<div class="mb-6">
							<strong class="mb-1 block">Type of Football</strong>
							<div class="text-sm">
								<?php echo facetwp_display('facet', 'type_of_football'); ?>
							</div>
						</div>
						<div class="mb-6">
						...
						<div class="mb-6">
							<strong class="mb-1 block">Role</strong>
							<div class="text-sm">
								<?php echo facetwp_display('facet', 'role'); ?>
							</div>
						</div>
						<div class="mb-6">
							<strong class="mb-1 block">Looking for</strong>
							<div class="text-sm">
								<?php echo facetwp_display('facet', 'level_men'); ?>
								<?php echo facetwp_display('facet', 'level_women'); ?>
								<?php echo facetwp_display('facet', 'level_staff'); ?>
							</div>
						</div>
					</div>
				</div>
				<div class="lg:w-3/4">
					...
					<div class="flex items-center justify-between text-sm pt-6 mt-6 border-t">
						<div class="flex items-center">
							<span class="mr-2">Sort By:</span><?php echo facetwp_display('facet', 'sort_'); ?>
						</div>
						<div class="flex items-center">
